...
export default function DeleteButton(props: any) {
  ...
  const handlePrint = async () => {
    try {
      const deleteuser = await fetch(`/api/dbuser/${userId}`, {
        method: "PUT",
        body: JSON.stringify({
          major: null,
        }),
      ...
      console.error("Error occurred while deleting user from Major", error);
    }
  };
                      ...
                      <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        ...
                        <div className="mt-2">
                          <p className="text-sm text-gray-500">
                            กรุณาตรวจสอบให้แน่ใจว่าต้องการลบนักศึกษา
                            เนื่องจากจะไม่สามารถกู้คืนนักศึกษาที่ลบไปแล้วได้
                          </p>
                        </div>
                      </div>
                    </div>
