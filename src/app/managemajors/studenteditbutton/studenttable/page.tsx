...
export default function StudentTable(props: any) {
  ...
  const totalItems = data ? data.majors.length : 0; // จำนวนรายการทั้งหมด
    ...
    <>
      <div className="overflow-x-auto mb-10">
        <div className="pt-4 relative mx-auto text-black container block md:flex md:items-center">
          ...
          <AddButton majorId={majorId} refreshData={props.refreshData}/>    
        </div>
            ...
            <table className="table-auto w-full ">
              <thead className="border-b">
                <tr className="bg-blue-400">
                  ...
                  {/* <th className="text-left p-4 font-medium">ระดับผู้ใช้</th> */}
                ...
                {filteredData
                  ...
                  .map((item: any, index: number) => (
                    <tr key={index} className="border-b hover:bg-gray-50">
                      ...
                      {/* <td className="p-4">{item.role || "ไม่มีข้อมูล"}</td> */}
                      <td className="p-4">
                        {/* <DeleteButton userId={item.userId} refreshData={refreshData} /> */}
                        <DeleteButton userId={item.userId} refreshData={props.refreshData} />
