...
export default function DetailButton(props: any) {
  ...
  // const headdepartmentId = props.majorItem.headdepartmentId;
  // const headdepartmentPrefix = props.majorItem.headdepartmentPrefix;
  // const headdepartmentName = props.majorItem.headdepartmentName;
  // const headdepartmentLastName = props.majorItem.headdepartmentLastName;
  

  const refreshData = () => {
    fetch(`/api/dbmajor/userinmajor/${majorItem.majorId}`)
      .then((res) => res.json())
      .then((data) => {
        setData(data);
        if (data) {
                      ...
                      <div className="mt-3 text-center sm:mt-0 sm:text-left">
                        ...
                        <div className="mt-2">
                          <div className="grid grid-cols-12 gap-2">
                            ...
                            <p className="py-2 col-span-12 md:col-span-8">
                              {majorItem?.headdepartmentPrefix}  {majorItem?.headdepartmentName}  {majorItem?.headdepartmentLastName} 
                            </p>
