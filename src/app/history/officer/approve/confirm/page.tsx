...
export default function ConfirmTeacherModal({ isOpen, onConfirm, onCancel }:any) {

  const cancelButtonRef = useRef(null)

  return (
    <>
    {isOpen && // ตรวจสอบว่า isOpen เป็น true หรือไม่
                      ...
                      <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        ...
                        <div className="mt-2">
                          <p className="text-sm text-gray-500">
                            ตรวจสอบข้อมูลให้ครบถ้วน ถ้ามีข้อมูลผิดพลาดจะต้องแจ้งผู้ดูแลระบบเพื่อทำการแก้ไขเท่านั้น
                          </p>
                        </div>
                      </div>
                    </div>
